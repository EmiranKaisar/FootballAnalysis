...
- Let the user review estimated events against their original clip timestamps.
...
3. The user previews the video and calibrates the two teams:
...
5. The completed Analysis Report presents team metrics, quality information, an estimated-event timeline, and event review against the source video.
...
- a timestamped estimated-event timeline with an event-review video action.
